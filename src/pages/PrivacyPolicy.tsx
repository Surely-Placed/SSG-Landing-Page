      ...
      <div className="container py-16 lg:py-20">
        <div className="mx-auto max-w-3xl">
          ...
          ">
            ...
            <p>
              SSG Global ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we
              collect, use, disclose, and safeguard your information when you use our website and career services
              ("Service"). Please read this Privacy Policy carefully. By using our Service, you agree to the collection
            ...
            <p>
              <strong>Contact Information:</strong> When you submit a form or contact us, we may collect your name, email
              address, phone number, and the message content you provide.
            </p>
            <p>
              <strong>Career Documents:</strong> If you share a resume, profile, or related documents, we may collect the
              content you provide, which may include work history, education, skills, and other information contained in
              those documents.
            </p>
            <p>
              <strong>Profile Information:</strong> Any additional information you choose to share with us in connection
              with career mentorship or recruitment support.
            </p>
            <p>
              <strong>Communication Data:</strong> Information you provide when communicating with our team.
            </p>

            <h3>2.2 Automatically Collected Information</h3>
            <p>
              <strong>Usage Data:</strong> Information about how you access and use our Service, including IP address,
              browser type, device information, pages visited, and time spent on pages.
            </p>
            <p>
              <strong>Cookies and Tracking Technologies:</strong> We may use cookies and similar technologies to track
              activity on our Service and store certain information.
            </p>
            <p>
              <strong>Log Data:</strong> Server logs that may include your IP address, browser type, browser version, pages
            ...
            <ul>
              ...
              <li>To send updates and service-related communications (and marketing, where permitted/with consent)</li>
            ...
            <ul>
              <li>
                ...
                services on our behalf, such as cloud hosting, analytics, and customer support. These providers are
              ...
              <li>
                ...
                government regulation, or to protect our rights, property, or safety, or that of our users.
              </li>
              <li>
              ...
              <li>
                <strong>With Your Consent:</strong> We may share your information with your explicit consent for any other
                purpose.
              </li>
            </ul>
            ...
            <ul>
              ...
              <li><strong>Correction:</strong> You can request updates or corrections to your personal information.</li>
              ...
              <li><strong>Opt-Out:</strong> You can opt-out of marketing communications using the unsubscribe link in our emails.</li>
