...
export function NavBar({ items, className }: NavBarProps) {
  ...
  return (
    <div
      className={cn(
        // Important: avoid a full-height fixed overlay on larger screens.
        // `bottom-0` is for mobile; on `sm` and up we explicitly unset bottom so clicks pass through.
        "fixed left-1/2 -translate-x-1/2 z-50 pointer-events-none bottom-0 mb-6 sm:top-0 sm:bottom-auto sm:mb-0 sm:pt-6",
        className,
      )}
    >
